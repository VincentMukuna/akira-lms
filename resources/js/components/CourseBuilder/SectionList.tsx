    ...
    <ContextMenu>
      <ContextMenuTrigger asChild>
        <div
          ...
          className={cn(
            'flex cursor-pointer items-center gap-2 rounded-md border-2 p-2.5',
        ...
        >
          <div {...provided.dragHandleProps} className="flex items-center">
            <GripVertical className="h-4 w-4 cursor-grab text-muted-foreground/50 transition-colors hover:text-muted-foreground" />
          </div>
          <ModuleIcon
            className={cn(
      ...
      <ContextMenuContent>
        <ContextMenuItem onClick={() => onAction('Archive module')} className="gap-2">
...
function SectionItem({
  ...
  return (
    <ContextMenu>
          ...
          >
            <CardHeader className="p-4 pb-0">
              <div className="flex items-center gap-3" {...provided.dragHandleProps}>
                <GripVertical className="h-5 w-5 cursor-grab text-muted-foreground/50 transition-colors hover:text-muted-foreground" />
                <Input
                  value={sectionTitle}
                  ...
                  className="h-9 border-transparent bg-transparent text-lg font-medium transition-colors hover:border-input focus:border-input"
                  placeholder="Section Title"
                />
                <ModuleTypeSelector onSelect={(type) => onModuleAdd(type)} />
              </div>
            </CardHeader>
      ...
      <ContextMenuContent>
        <ContextMenuItem onClick={() => onAction('Archive section')} className="gap-2">
          <Archive className="h-4 w-4" />
          Archive
        </ContextMenuItem>
        <ContextMenuSeparator />
...
export default function SectionList({
  ...
  return (
    <div className="space-y-6">
      ...
      <Button
        variant="outline"
        className="w-full border-2 border-dashed transition-colors hover:border-primary hover:bg-primary/5 hover:text-black"
