...
export const setModuleEditorState = atom(null, (get, set, module: BaseModule | null) => {
...
export const updateCurrentModule = atom(null, (get, set, updates: Partial<BaseModule>) => {
...
export const resetModuleEditor = atom(null, (get, set) => {
  const state = get(moduleEditorStore);
  set(moduleEditorStore, {
    ...state,
    isDirty: false,
