import {
  getModuleEditorState,
  setModuleEditorState,
  updateCurrentModule,
} from '@/components/CourseBuilder/store/module-editor';
...
export default function ModuleFactory({ module, onChange }: ModuleFactoryProps) {
  ...
  if (!moduleType) {
    ...
    return <div className="p-4 text-center text-red-500">Unknown module type: {module.type}</div>;
  }
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <Button variant="outline" onClick={handleReset} disabled={!editorState.isDirty}>
            Cancel
          </Button>
